		...
		public class _
		{
			...
			public class aprobacionRelation : DataManagerBase.JoinPathRelation
			{
				...
				public JoinPath._.solicitudRelation solicitud
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("solicitud","id","aprobacion","idMantenimiento", this.OrmAlias, this.OrmAlias + "_soli5", true));
						return new JoinPath._.solicitudRelation( RelationList, this.OrmAlias + "_soli5"); 
					}
				}
				...
				public JoinPath._.UsuarioRelation Usuario
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("Usuario","id","aprobacion","idusuario", this.OrmAlias, this.OrmAlias + "_Usua17", true));
						return new JoinPath._.UsuarioRelation( RelationList, this.OrmAlias + "_Usua17"); 
					}
				}
			...
			public class componenteRelation : DataManagerBase.JoinPathRelation
			{
				...
				public JoinPath._.proveedorRelation proveedor
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("proveedor","id","componente","idproveedor", this.OrmAlias, this.OrmAlias + "_prov13", true));
						return new JoinPath._.proveedorRelation( RelationList, this.OrmAlias + "_prov13"); 
					}
				}
			...
			public class detalle_reparoRelation : DataManagerBase.JoinPathRelation
			{
				...
				public JoinPath._.maquinaRelation maquina
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("maquina","id","detalle_reparo","idmaquina", this.OrmAlias, this.OrmAlias + "_maqu6", true));
				...
				public JoinPath._.materialusadoRelation materialusado
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("materialusado","id","detalle_reparo","idmaterialusado", this.OrmAlias, this.OrmAlias + "_mate11", true));
						return new JoinPath._.materialusadoRelation( RelationList, this.OrmAlias + "_mate11"); 
					}
				}
				...
				public JoinPath._.problemaRelation problema
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("problema","id","detalle_reparo","idproblema", this.OrmAlias, this.OrmAlias + "_prob12", true));
						return new JoinPath._.problemaRelation( RelationList, this.OrmAlias + "_prob12"); 
					}
				}
			...
			public class funcionRelation : DataManagerBase.JoinPathRelation
			{
				...
				public JoinPath._.privilegioRelation privilegio
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("funcion","id","privilegio","idfuncion", this.OrmAlias, this.OrmAlias + "_priv3", false));
						return new JoinPath._.privilegioRelation( RelationList, this.OrmAlias + "_priv3"); 
					}
				}
			...
			public class linea_produccionRelation : DataManagerBase.JoinPathRelation
			{
				...
				public JoinPath._.maquinaRelation maquina
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("linea_produccion","id","maquina","idlinea", this.OrmAlias, this.OrmAlias + "_maqu4", false));
			...
			public class maquinaRelation : DataManagerBase.JoinPathRelation
			{
				...
				public JoinPath._.detalle_reparoRelation detalle_reparo
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("maquina","id","detalle_reparo","idmaquina", this.OrmAlias, this.OrmAlias + "_deta6", false));
				...
				public JoinPath._.problemaRelation problema
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("maquina","id","problema","idmaquina", this.OrmAlias, this.OrmAlias + "_prob7", false));
						return new JoinPath._.problemaRelation( RelationList, this.OrmAlias + "_prob7"); 
					}
				}
				...
				public JoinPath._.recomendacionRelation recomendacion
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("maquina","id","recomendacion","idmaquina", this.OrmAlias, this.OrmAlias + "_reco8", false));
						return new JoinPath._.recomendacionRelation( RelationList, this.OrmAlias + "_reco8"); 
					}
				}
				...
				public JoinPath._.solicitudRelation solicitud
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("maquina","id","solicitud","idMaquina", this.OrmAlias, this.OrmAlias + "_soli9", false));
						return new JoinPath._.solicitudRelation( RelationList, this.OrmAlias + "_soli9"); 
					}
				}
				...
				public JoinPath._.linea_produccionRelation linea_produccion
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("linea_produccion","id","maquina","idlinea", this.OrmAlias, this.OrmAlias + "_line4", true));
						return new JoinPath._.linea_produccionRelation( RelationList, this.OrmAlias + "_line4"); 
					}
				}
			...
			public class material_herramientaRelation : DataManagerBase.JoinPathRelation
			{
				...
				public JoinPath._.proveedorRelation proveedor
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("proveedor","id","material_herramienta","idproveedor", this.OrmAlias, this.OrmAlias + "_prov14", true));
			...
			public class materialusadoRelation : DataManagerBase.JoinPathRelation
			{
				...
				public JoinPath._.detalle_reparoRelation detalle_reparo
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("materialusado","id","detalle_reparo","idmaterialusado", this.OrmAlias, this.OrmAlias + "_deta11", false));
						return new JoinPath._.detalle_reparoRelation( RelationList, this.OrmAlias + "_deta11"); 
					}
				}
			...
			public class privilegioRelation : DataManagerBase.JoinPathRelation
			{
				...
				public JoinPath._.funcionRelation funcion
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("funcion","id","privilegio","idfuncion", this.OrmAlias, this.OrmAlias + "_func3", true));
						return new JoinPath._.funcionRelation( RelationList, this.OrmAlias + "_func3"); 
					}
				}
				...
				public JoinPath._.rolRelation rol
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("rol","id","privilegio","idrol", this.OrmAlias, this.OrmAlias + "_rol16", true));
			...
			public class problemaRelation : DataManagerBase.JoinPathRelation
			{
				...
				public JoinPath._.detalle_reparoRelation detalle_reparo
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("problema","id","detalle_reparo","idproblema", this.OrmAlias, this.OrmAlias + "_deta12", false));
						return new JoinPath._.detalle_reparoRelation( RelationList, this.OrmAlias + "_deta12"); 
					}
				}
				...
				public JoinPath._.maquinaRelation maquina
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("maquina","id","problema","idmaquina", this.OrmAlias, this.OrmAlias + "_maqu7", true));
						return new JoinPath._.maquinaRelation( RelationList, this.OrmAlias + "_maqu7"); 
					}
				}
			...
			public class proveedorRelation : DataManagerBase.JoinPathRelation
			{
				...
				public JoinPath._.componenteRelation componente
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("proveedor","id","componente","idproveedor", this.OrmAlias, this.OrmAlias + "_comp13", false));
						return new JoinPath._.componenteRelation( RelationList, this.OrmAlias + "_comp13"); 
					}
				}
				...
				public JoinPath._.material_herramientaRelation material_herramienta
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("proveedor","id","material_herramienta","idproveedor", this.OrmAlias, this.OrmAlias + "_mate14", false));
						return new JoinPath._.material_herramientaRelation( RelationList, this.OrmAlias + "_mate14"); 
					}
				}
			...
			public class recomendacionRelation : DataManagerBase.JoinPathRelation
			{
				...
				public JoinPath._.maquinaRelation maquina
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("maquina","id","recomendacion","idmaquina", this.OrmAlias, this.OrmAlias + "_maqu8", true));
			...
			public class rolRelation : DataManagerBase.JoinPathRelation
			{
				...
				public JoinPath._.UsuarioRelation Usuario
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("rol","id","Usuario","idrol", this.OrmAlias, this.OrmAlias + "_Usua15", false));
						return new JoinPath._.UsuarioRelation( RelationList, this.OrmAlias + "_Usua15"); 
					}
				}
				...
				public JoinPath._.privilegioRelation privilegio
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("rol","id","privilegio","idrol", this.OrmAlias, this.OrmAlias + "_priv16", false));
						return new JoinPath._.privilegioRelation( RelationList, this.OrmAlias + "_priv16"); 
					}
				}
			...
			public class solicitudRelation : DataManagerBase.JoinPathRelation
			{
				...
				public JoinPath._.aprobacionRelation aprobacion
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("solicitud","id","aprobacion","idMantenimiento", this.OrmAlias, this.OrmAlias + "_apro5", false));
						return new JoinPath._.aprobacionRelation( RelationList, this.OrmAlias + "_apro5"); 
					}
				}
				...
				public JoinPath._.maquinaRelation maquina
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("maquina","id","solicitud","idMaquina", this.OrmAlias, this.OrmAlias + "_maqu9", true));
			...
			public class UsuarioRelation : DataManagerBase.JoinPathRelation
			{
				...
				public JoinPath._.aprobacionRelation aprobacion
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("Usuario","id","aprobacion","idusuario", this.OrmAlias, this.OrmAlias + "_apro17", false));
						return new JoinPath._.aprobacionRelation( RelationList, this.OrmAlias + "_apro17"); 
					}
				}
				...
				public JoinPath._.rolRelation rol
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("rol","id","Usuario","idrol", this.OrmAlias, this.OrmAlias + "_rol15", true));
						return new JoinPath._.rolRelation( RelationList, this.OrmAlias + "_rol15"); 
					}
				}
