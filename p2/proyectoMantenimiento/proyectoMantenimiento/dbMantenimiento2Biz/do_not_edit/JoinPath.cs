		...
		public class _
		{
			...
			public class aprobacionRelation : DataManagerBase.JoinPathRelation
			{
				...
				public JoinPath._.solicitudRelation solicitud
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("solicitud","id","aprobacion","idMantenimiento", this.OrmAlias, this.OrmAlias + "_soli1", true));
						return new JoinPath._.solicitudRelation( RelationList, this.OrmAlias + "_soli1"); 
					}
				}
				...
				public JoinPath._.UsuarioRelation Usuario
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("Usuario","id","aprobacion","idusuario", this.OrmAlias, this.OrmAlias + "_Usua2", true));
						return new JoinPath._.UsuarioRelation( RelationList, this.OrmAlias + "_Usua2"); 
					}
				}
			...
			public class componenteRelation : DataManagerBase.JoinPathRelation
			{
				...
				public JoinPath._.proveedorRelation proveedor
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("proveedor","id","componente","idproveedor", this.OrmAlias, this.OrmAlias + "_prov3", true));
						return new JoinPath._.proveedorRelation( RelationList, this.OrmAlias + "_prov3"); 
					}
				}
			...
			public class detalle_reparoRelation : DataManagerBase.JoinPathRelation
			{
				...
				public JoinPath._.maquinaRelation maquina
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("maquina","id","detalle_reparo","idmaquina", this.OrmAlias, this.OrmAlias + "_maqu4", true));
						return new JoinPath._.maquinaRelation( RelationList, this.OrmAlias + "_maqu4"); 
					}
				}
				...
				public JoinPath._.materialusadoRelation materialusado
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("materialusado","id","detalle_reparo","idmaterialusado", this.OrmAlias, this.OrmAlias + "_mate5", true));
				...
				public JoinPath._.problemaRelation problema
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("problema","id","detalle_reparo","idproblema", this.OrmAlias, this.OrmAlias + "_prob6", true));
						return new JoinPath._.problemaRelation( RelationList, this.OrmAlias + "_prob6"); 
					}
				}
				...
				public JoinPath._.UsuarioRelation Usuario
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("Usuario","id","detalle_reparo","idusuario", this.OrmAlias, this.OrmAlias + "_Usua7", true));
						return new JoinPath._.UsuarioRelation( RelationList, this.OrmAlias + "_Usua7"); 
					}
				}
			...
			public class funcionRelation : DataManagerBase.JoinPathRelation
			{
				...
				public JoinPath._.privilegioRelation privilegio
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("funcion","id","privilegio","idfuncion", this.OrmAlias, this.OrmAlias + "_priv13", false));
						return new JoinPath._.privilegioRelation( RelationList, this.OrmAlias + "_priv13"); 
					}
				}
			...
			public class inventarioRelation : DataManagerBase.JoinPathRelation
			{
				...
				public JoinPath._.material_herramientaRelation material_herramienta
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("material_herramienta","id","inventario","idmaterial", this.OrmAlias, this.OrmAlias + "_mate10", true));
						return new JoinPath._.material_herramientaRelation( RelationList, this.OrmAlias + "_mate10"); 
					}
				}
			...
			public class linea_produccionRelation : DataManagerBase.JoinPathRelation
			{
				...
				public JoinPath._.maquinaRelation maquina
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("linea_produccion","id","maquina","idlinea", this.OrmAlias, this.OrmAlias + "_maqu11", false));
			...
			public class maquinaRelation : DataManagerBase.JoinPathRelation
			{
				...
				public JoinPath._.detalle_reparoRelation detalle_reparo
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("maquina","id","detalle_reparo","idmaquina", this.OrmAlias, this.OrmAlias + "_deta4", false));
						return new JoinPath._.detalle_reparoRelation( RelationList, this.OrmAlias + "_deta4"); 
					}
				}
				...
				public JoinPath._.problemaRelation problema
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("maquina","id","problema","idmaquina", this.OrmAlias, this.OrmAlias + "_prob15", false));
						return new JoinPath._.problemaRelation( RelationList, this.OrmAlias + "_prob15"); 
					}
				}
				...
				public JoinPath._.recomendacionRelation recomendacion
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("maquina","id","recomendacion","idmaquina", this.OrmAlias, this.OrmAlias + "_reco16", false));
						return new JoinPath._.recomendacionRelation( RelationList, this.OrmAlias + "_reco16"); 
					}
				}
				...
				public JoinPath._.solicitudRelation solicitud
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("maquina","id","solicitud","idMaquina", this.OrmAlias, this.OrmAlias + "_soli17", false));
						return new JoinPath._.solicitudRelation( RelationList, this.OrmAlias + "_soli17"); 
					}
				}
				...
				public JoinPath._.linea_produccionRelation linea_produccion
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("linea_produccion","id","maquina","idlinea", this.OrmAlias, this.OrmAlias + "_line11", true));
						return new JoinPath._.linea_produccionRelation( RelationList, this.OrmAlias + "_line11"); 
					}
				}
			...
			public class material_herramientaRelation : DataManagerBase.JoinPathRelation
			{
				...
				public JoinPath._.inventarioRelation inventario
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("material_herramienta","id","inventario","idmaterial", this.OrmAlias, this.OrmAlias + "_inve10", false));
						return new JoinPath._.inventarioRelation( RelationList, this.OrmAlias + "_inve10"); 
					}
				}
				...
				public JoinPath._.proveedorRelation proveedor
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("proveedor","id","material_herramienta","idproveedor", this.OrmAlias, this.OrmAlias + "_prov12", true));
						return new JoinPath._.proveedorRelation( RelationList, this.OrmAlias + "_prov12"); 
					}
				}
			...
			public class materialusadoRelation : DataManagerBase.JoinPathRelation
			{
				...
				public JoinPath._.detalle_reparoRelation detalle_reparo
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("materialusado","id","detalle_reparo","idmaterialusado", this.OrmAlias, this.OrmAlias + "_deta5", false));
						return new JoinPath._.detalle_reparoRelation( RelationList, this.OrmAlias + "_deta5"); 
					}
				}
			...
			public class privilegioRelation : DataManagerBase.JoinPathRelation
			{
				...
				public JoinPath._.funcionRelation funcion
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("funcion","id","privilegio","idfuncion", this.OrmAlias, this.OrmAlias + "_func13", true));
						return new JoinPath._.funcionRelation( RelationList, this.OrmAlias + "_func13"); 
					}
				}
				...
				public JoinPath._.rolRelation rol
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("rol","id","privilegio","idrol", this.OrmAlias, this.OrmAlias + "_rol14", true));
						return new JoinPath._.rolRelation( RelationList, this.OrmAlias + "_rol14"); 
					}
				}
			...
			public class problemaRelation : DataManagerBase.JoinPathRelation
			{
				...
				public JoinPath._.detalle_reparoRelation detalle_reparo
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("problema","id","detalle_reparo","idproblema", this.OrmAlias, this.OrmAlias + "_deta6", false));
						return new JoinPath._.detalle_reparoRelation( RelationList, this.OrmAlias + "_deta6"); 
					}
				}
				...
				public JoinPath._.maquinaRelation maquina
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("maquina","id","problema","idmaquina", this.OrmAlias, this.OrmAlias + "_maqu15", true));
						return new JoinPath._.maquinaRelation( RelationList, this.OrmAlias + "_maqu15"); 
					}
				}
			...
			public class proveedorRelation : DataManagerBase.JoinPathRelation
			{
				...
				public JoinPath._.componenteRelation componente
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("proveedor","id","componente","idproveedor", this.OrmAlias, this.OrmAlias + "_comp3", false));
						return new JoinPath._.componenteRelation( RelationList, this.OrmAlias + "_comp3"); 
					}
				}
				...
				public JoinPath._.material_herramientaRelation material_herramienta
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("proveedor","id","material_herramienta","idproveedor", this.OrmAlias, this.OrmAlias + "_mate12", false));
			...
			public class recomendacionRelation : DataManagerBase.JoinPathRelation
			{
				...
				public JoinPath._.maquinaRelation maquina
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("maquina","id","recomendacion","idmaquina", this.OrmAlias, this.OrmAlias + "_maqu16", true));
						return new JoinPath._.maquinaRelation( RelationList, this.OrmAlias + "_maqu16"); 
					}
				}
			...
			public class rolRelation : DataManagerBase.JoinPathRelation
			{
				...
				public JoinPath._.privilegioRelation privilegio
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("rol","id","privilegio","idrol", this.OrmAlias, this.OrmAlias + "_priv14", false));
						return new JoinPath._.privilegioRelation( RelationList, this.OrmAlias + "_priv14"); 
					}
				}
				...
				public JoinPath._.UsuarioRelation Usuario
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("rol","id","Usuario","idrol", this.OrmAlias, this.OrmAlias + "_Usua19", false));
			...
			public class solicitudRelation : DataManagerBase.JoinPathRelation
			{
				...
				public JoinPath._.aprobacionRelation aprobacion
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("solicitud","id","aprobacion","idMantenimiento", this.OrmAlias, this.OrmAlias + "_apro1", false));
						return new JoinPath._.aprobacionRelation( RelationList, this.OrmAlias + "_apro1"); 
					}
				}
				...
				public JoinPath._.maquinaRelation maquina
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("maquina","id","solicitud","idMaquina", this.OrmAlias, this.OrmAlias + "_maqu17", true));
						return new JoinPath._.maquinaRelation( RelationList, this.OrmAlias + "_maqu17"); 
					}
				}
				...
				public JoinPath._.UsuarioRelation Usuario
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("Usuario","id","solicitud","idusuario", this.OrmAlias, this.OrmAlias + "_Usua18", true));
			...
			public class UsuarioRelation : DataManagerBase.JoinPathRelation
			{
				...
				public JoinPath._.aprobacionRelation aprobacion
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("Usuario","id","aprobacion","idusuario", this.OrmAlias, this.OrmAlias + "_apro2", false));
						return new JoinPath._.aprobacionRelation( RelationList, this.OrmAlias + "_apro2"); 
					}
				}
				...
				public JoinPath._.detalle_reparoRelation detalle_reparo
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("Usuario","id","detalle_reparo","idusuario", this.OrmAlias, this.OrmAlias + "_deta7", false));
						return new JoinPath._.detalle_reparoRelation( RelationList, this.OrmAlias + "_deta7"); 
					}
				}
				...
				public JoinPath._.solicitudRelation solicitud
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("Usuario","id","solicitud","idusuario", this.OrmAlias, this.OrmAlias + "_soli18", false));
						return new JoinPath._.solicitudRelation( RelationList, this.OrmAlias + "_soli18"); 
					}
				}
				...
				public JoinPath._.rolRelation rol
				{
					get
					{
						RelationList.Add(new DataManagerBase.Relation("rol","id","Usuario","idrol", this.OrmAlias, this.OrmAlias + "_rol19", true));
						return new JoinPath._.rolRelation( RelationList, this.OrmAlias + "_rol19"); 
					}
				}
				...
				public class detalle_reparoColumns : DataManagerBase.JoinPathRelation
				{
					...
					/// <summary>
					/// Apply constraint to the idmaterialusado
					/// </summary>
					/// <value>
					/// A relationship chain to constrain the criteria with
					/// </value>
					public DataManagerBase.JoinPathRelation idmaterialusado
					{
						get
						{							
							RelationList.Add(new DataManagerBase.Relation("detalle_reparo","idmaterialusado","","", this.OrmAlias, this.OrmAlias));
							return this;
						}
					}
