...
namespace dbMantenimiento2Biz
{
		...
		/// <summary>
		/// Find a detalle_reparo by the property idmaterialusado.
		/// returns null if not found.
		/// </summary>
		/// <param name="searchValue">The value to search for</param>
		/// <returns>An detalle_reparo if found, or null</returns>
		public	detalle_reparo	FindByidmaterialusado( System.Data.SqlTypes.SqlInt32 searchValue )
		{
			return FindByidmaterialusado( searchValue, OrmLib.CompareType.Exact );
		}
		...
		/// <param name="comparer">What sort of comparison should be made</param>
		/// <returns>An detalle_reparo if found, or null</returns>
		public	detalle_reparo	FindByidmaterialusado( System.Data.SqlTypes.SqlInt32 searchValue, OrmLib.CompareType comparer )
		{
			foreach( detalle_reparo _detalle_reparo in List)
			{
				if ( Match(comparer,_detalle_reparo.idmaterialusado , searchValue) ) 
					return _detalle_reparo;
			}
		...
		/// <param name="searchValue">The value to search for</param>
		/// <returns>An detalle_reparo if found, or null</returns>
		public	detalle_reparo	FindByidmaterialusado( string searchValue )
		{
			return FindByidmaterialusado( System.Data.SqlTypes.SqlInt32.Parse(searchValue), OrmLib.CompareType.Exact );
		}
		...
		/// <param name="comparer">What sort of comparison should be made</param>
		/// <returns>An detalle_reparo if found, or null</returns>
		public	detalle_reparo	FindByidmaterialusado( string searchValue, OrmLib.CompareType comparer )
		{
			return FindByidmaterialusado( System.Data.SqlTypes.SqlInt32.Parse(searchValue),comparer );
		}		/// <summary>
		...
		/// <summary>
		/// Filter by the property idmaterialusado.
		/// </summary>
		/// <param name="searchValue">The value to search for</param>
		/// <returns>A detalle_reparoCollection of detalle_reparos</returns>
		public	detalle_reparoCollection	FilterByidmaterialusado( System.Data.SqlTypes.SqlInt32 searchValue )
		{
			return FilterByidmaterialusado( searchValue, OrmLib.CompareType.Exact );
		}
		...
		/// <param name="comparer">What sort of comparison should be made</param>
		/// <returns>A detalle_reparoCollection of detalle_reparos</returns>
		public	detalle_reparoCollection	FilterByidmaterialusado( System.Data.SqlTypes.SqlInt32 searchValue, OrmLib.CompareType comparer )
		{
			detalle_reparoCollection retCollection = new detalle_reparoCollection();
		...
		/// <param name="searchValue">The value to search for</param>
		/// <returns>A detalle_reparoCollection of detalle_reparos</returns>
		public	detalle_reparoCollection	FilterByidmaterialusado( string searchValue )
		{
			return FilterByidmaterialusado( System.Data.SqlTypes.SqlInt32.Parse(searchValue), OrmLib.CompareType.Exact );
		}
		...
		/// <param name="comparer">What sort of comparison should be made</param>
		/// <returns>A detalle_reparoCollection of detalle_reparos</returns>
		public	detalle_reparoCollection	FilterByidmaterialusado( string searchValue, OrmLib.CompareType comparer )
		{
			return FilterByidmaterialusado( System.Data.SqlTypes.SqlInt32.Parse(searchValue),comparer );
		}
		/// <summary>
		/// Filter by the property id.
		/// </summary>
		...
		/// <summary>
		/// Sorts a detalle_reparo by the property idmaterialusado.
		/// </summary>
		/// <param name="sortDirection">The direction to sort in</param>
		/// <returns>The collection in sorted order</returns>
		public	detalle_reparoCollection	SortByidmaterialusado ( OrmLib.SortDirection sortDirection )
		{
			InnerList.Sort( new OrmLib.ObjectPropertyComparer("idmaterialusado"));
			if (sortDirection == OrmLib.SortDirection.Descending) InnerList.Reverse();
			return (detalle_reparoCollection)this;
		}
