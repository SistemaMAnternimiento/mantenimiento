		...
		public class _
		{
			...
			{			
				...
				public FetchPath._.solicitudRelation solicitud
				{
					...
					{
						RelationList.Add(new DataManagerBase.Relation("solicitud","id","aprobacion","idMantenimiento", this.OrmAlias, this.OrmAlias + "_soli1", true ));
						return new FetchPath._.solicitudRelation(RelationList, this.OrmAlias + "_soli1"); 
					}
				}
				...
				public FetchPath._.UsuarioRelation Usuario
				{
					...
					{
						RelationList.Add(new DataManagerBase.Relation("Usuario","id","aprobacion","idusuario", this.OrmAlias, this.OrmAlias + "_Usua2", true ));
						return new FetchPath._.UsuarioRelation(RelationList, this.OrmAlias + "_Usua2"); 
					}
				}
			...
			{			
				...
				public FetchPath._.proveedorRelation proveedor
				{
					...
					{
						RelationList.Add(new DataManagerBase.Relation("proveedor","id","componente","idproveedor", this.OrmAlias, this.OrmAlias + "_prov3", true ));
						return new FetchPath._.proveedorRelation(RelationList, this.OrmAlias + "_prov3"); 
					}
				}
			...
			{			
				...
				public FetchPath._.maquinaRelation maquina
				{
					...
					{
						RelationList.Add(new DataManagerBase.Relation("maquina","id","detalle_reparo","idmaquina", this.OrmAlias, this.OrmAlias + "_maqu4", true ));
						return new FetchPath._.maquinaRelation(RelationList, this.OrmAlias + "_maqu4"); 
					}
				}
				...
				public FetchPath._.problemaRelation problema
				{
					...
					{
						RelationList.Add(new DataManagerBase.Relation("problema","id","detalle_reparo","idproblema", this.OrmAlias, this.OrmAlias + "_prob6", true ));
						return new FetchPath._.problemaRelation(RelationList, this.OrmAlias + "_prob6"); 
					}
				}
				...
				public FetchPath._.UsuarioRelation Usuario
				{
					...
					{
						RelationList.Add(new DataManagerBase.Relation("Usuario","id","detalle_reparo","idusuario", this.OrmAlias, this.OrmAlias + "_Usua7", true ));
						return new FetchPath._.UsuarioRelation(RelationList, this.OrmAlias + "_Usua7"); 
					}
				}
			...
			{			
				...
				public FetchPath._.privilegioRelation privilegio
				{
					...
					{
						RelationList.Add(new DataManagerBase.Relation("funcion","id","privilegio","idfuncion", this.OrmAlias, this.OrmAlias + "_priv13", false ));
						return new FetchPath._.privilegioRelation(RelationList, this.OrmAlias + "_priv13"); 
					}
				}
			...
			{			
				...
				public FetchPath._.material_herramientaRelation material_herramienta
				{
					...
					{
						RelationList.Add(new DataManagerBase.Relation("material_herramienta","id","inventario","idmaterial", this.OrmAlias, this.OrmAlias + "_mate10", true ));
						return new FetchPath._.material_herramientaRelation(RelationList, this.OrmAlias + "_mate10"); 
					}
				}
			...
			{			
				...
				public FetchPath._.detalle_reparoRelation detalle_reparo
				{
					...
					{
						RelationList.Add(new DataManagerBase.Relation("maquina","id","detalle_reparo","idmaquina", this.OrmAlias, this.OrmAlias + "_deta4", false ));
						return new FetchPath._.detalle_reparoRelation(RelationList, this.OrmAlias + "_deta4"); 
					}
				}
				...
				public FetchPath._.problemaRelation problema
				{
					...
					{
						RelationList.Add(new DataManagerBase.Relation("maquina","id","problema","idmaquina", this.OrmAlias, this.OrmAlias + "_prob15", false ));
						return new FetchPath._.problemaRelation(RelationList, this.OrmAlias + "_prob15"); 
					}
				}
				...
				public FetchPath._.recomendacionRelation recomendacion
				{
					...
					{
						RelationList.Add(new DataManagerBase.Relation("maquina","id","recomendacion","idmaquina", this.OrmAlias, this.OrmAlias + "_reco16", false ));
						return new FetchPath._.recomendacionRelation(RelationList, this.OrmAlias + "_reco16"); 
					}
				}
				...
				public FetchPath._.solicitudRelation solicitud
				{
					...
					{
						RelationList.Add(new DataManagerBase.Relation("maquina","id","solicitud","idMaquina", this.OrmAlias, this.OrmAlias + "_soli17", false ));
						return new FetchPath._.solicitudRelation(RelationList, this.OrmAlias + "_soli17"); 
					}
				}
				...
				public FetchPath._.linea_produccionRelation linea_produccion
				{
					...
					{
						RelationList.Add(new DataManagerBase.Relation("linea_produccion","id","maquina","idlinea", this.OrmAlias, this.OrmAlias + "_line11", true ));
						return new FetchPath._.linea_produccionRelation(RelationList, this.OrmAlias + "_line11"); 
					}
				}
			...
			{			
				...
				public FetchPath._.inventarioRelation inventario
				{
					...
					{
						RelationList.Add(new DataManagerBase.Relation("material_herramienta","id","inventario","idmaterial", this.OrmAlias, this.OrmAlias + "_inve10", false ));
						return new FetchPath._.inventarioRelation(RelationList, this.OrmAlias + "_inve10"); 
					}
				}
				...
				public FetchPath._.proveedorRelation proveedor
				{
					...
					{
						RelationList.Add(new DataManagerBase.Relation("proveedor","id","material_herramienta","idproveedor", this.OrmAlias, this.OrmAlias + "_prov12", true ));
						return new FetchPath._.proveedorRelation(RelationList, this.OrmAlias + "_prov12"); 
					}
				}
			...
			{			
				...
				public FetchPath._.detalle_reparoRelation detalle_reparo
				{
					...
					{
						RelationList.Add(new DataManagerBase.Relation("materialusado","id","detalle_reparo","idmaterialusado", this.OrmAlias, this.OrmAlias + "_deta5", false ));
						return new FetchPath._.detalle_reparoRelation(RelationList, this.OrmAlias + "_deta5"); 
					}
				}
			...
			{			
				...
				public FetchPath._.funcionRelation funcion
				{
					...
					{
						RelationList.Add(new DataManagerBase.Relation("funcion","id","privilegio","idfuncion", this.OrmAlias, this.OrmAlias + "_func13", true ));
						return new FetchPath._.funcionRelation(RelationList, this.OrmAlias + "_func13"); 
					}
				}
				...
				public FetchPath._.rolRelation rol
				{
					...
					{
						RelationList.Add(new DataManagerBase.Relation("rol","id","privilegio","idrol", this.OrmAlias, this.OrmAlias + "_rol14", true ));
						return new FetchPath._.rolRelation(RelationList, this.OrmAlias + "_rol14"); 
					}
				}
			...
			{			
				...
				public FetchPath._.detalle_reparoRelation detalle_reparo
				{
					...
					{
						RelationList.Add(new DataManagerBase.Relation("problema","id","detalle_reparo","idproblema", this.OrmAlias, this.OrmAlias + "_deta6", false ));
						return new FetchPath._.detalle_reparoRelation(RelationList, this.OrmAlias + "_deta6"); 
					}
				}
				...
				public FetchPath._.maquinaRelation maquina
				{
					...
					{
						RelationList.Add(new DataManagerBase.Relation("maquina","id","problema","idmaquina", this.OrmAlias, this.OrmAlias + "_maqu15", true ));
						return new FetchPath._.maquinaRelation(RelationList, this.OrmAlias + "_maqu15"); 
					}
				}
			...
			{			
				...
				public FetchPath._.componenteRelation componente
				{
					...
					{
						RelationList.Add(new DataManagerBase.Relation("proveedor","id","componente","idproveedor", this.OrmAlias, this.OrmAlias + "_comp3", false ));
						return new FetchPath._.componenteRelation(RelationList, this.OrmAlias + "_comp3"); 
					}
				}
			...
			{			
				...
				public FetchPath._.maquinaRelation maquina
				{
					...
					{
						RelationList.Add(new DataManagerBase.Relation("maquina","id","recomendacion","idmaquina", this.OrmAlias, this.OrmAlias + "_maqu16", true ));
						return new FetchPath._.maquinaRelation(RelationList, this.OrmAlias + "_maqu16"); 
					}
				}
			...
			{			
				...
				public FetchPath._.privilegioRelation privilegio
				{
					...
					{
						RelationList.Add(new DataManagerBase.Relation("rol","id","privilegio","idrol", this.OrmAlias, this.OrmAlias + "_priv14", false ));
						return new FetchPath._.privilegioRelation(RelationList, this.OrmAlias + "_priv14"); 
					}
				}
			...
			{			
				...
				public FetchPath._.aprobacionRelation aprobacion
				{
					...
					{
						RelationList.Add(new DataManagerBase.Relation("solicitud","id","aprobacion","idMantenimiento", this.OrmAlias, this.OrmAlias + "_apro1", false ));
						return new FetchPath._.aprobacionRelation(RelationList, this.OrmAlias + "_apro1"); 
					}
				}
				...
				public FetchPath._.maquinaRelation maquina
				{
					...
					{
						RelationList.Add(new DataManagerBase.Relation("maquina","id","solicitud","idMaquina", this.OrmAlias, this.OrmAlias + "_maqu17", true ));
						return new FetchPath._.maquinaRelation(RelationList, this.OrmAlias + "_maqu17"); 
					}
				}
			...
			{			
				...
				public FetchPath._.aprobacionRelation aprobacion
				{
					...
					{
						RelationList.Add(new DataManagerBase.Relation("Usuario","id","aprobacion","idusuario", this.OrmAlias, this.OrmAlias + "_apro2", false ));
						return new FetchPath._.aprobacionRelation(RelationList, this.OrmAlias + "_apro2"); 
					}
				}
				...
				public FetchPath._.detalle_reparoRelation detalle_reparo
				{
					...
					{
						RelationList.Add(new DataManagerBase.Relation("Usuario","id","detalle_reparo","idusuario", this.OrmAlias, this.OrmAlias + "_deta7", false ));
						return new FetchPath._.detalle_reparoRelation(RelationList, this.OrmAlias + "_deta7"); 
					}
				}
				...
				public FetchPath._.solicitudRelation solicitud
				{
					...
					{
						RelationList.Add(new DataManagerBase.Relation("Usuario","id","solicitud","idusuario", this.OrmAlias, this.OrmAlias + "_soli18", false ));
						return new FetchPath._.solicitudRelation(RelationList, this.OrmAlias + "_soli18"); 
					}
				}
				...
				public FetchPath._.rolRelation rol
				{
					...
					{
						RelationList.Add(new DataManagerBase.Relation("rol","id","Usuario","idrol", this.OrmAlias, this.OrmAlias + "_rol19", true ));
						return new FetchPath._.rolRelation(RelationList, this.OrmAlias + "_rol19"); 
					}
				}
